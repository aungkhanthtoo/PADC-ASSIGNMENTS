...
class CategoryItemViewHolder(itemView: View, private val mDelegate: CategoryProgramDelegate, private val categoryPosition: Int) : BaseViewHolder<ProgramVO>(itemView) {
    ...
    override fun onClick(v: View) {
        mDelegate.onTapCategoryProgramItem(adapterPosition, categoryPosition)
    }
